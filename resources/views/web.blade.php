...
@section('content')
  ...
  .br-w {
    background-image: url(../assets/img/services/Web\ Development\ Slider.jpg);
}
  </style>
      ...
      <div class="content-wrapper">
        <!-- Breadcrumb start -->
        <div class="breadcrumb-wrap bg-f br-w">
        ...
        <section class="service-details-wrap pt-100 pb-70">
          <div class="container">
            <div class="row gx-5">
              <div class="col-xl-8">
                <div class="service-desc">
                  <h1>Web Design and Deveplopment</h1>
                  <div class="service-img">
                    <img
                      src="../assets/img/services/web.jpeg"
                      alt="Image"
                    />
                  </div>
                  <p>
                ...
                <div class="row justify-content-center">
                  <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="service-card style4">
                      <div class="service-img">
                        <img
                          src="../assets/img/services/STACK IMAGES/Web Development/bootstrap.webp"
                          alt="Image"
                        />
                      </div>
                      <div class="service-info">
                        ...
                        <h3 class="service-title">
                          <a href="service-details.html">Bootstrap</a>
                        </h3>
                        <p>
                          Bootstrap streamlines web development with responsive,
                          pre-designed components, guaranteeing a consistent
                          user experience and faster project completion. Its
                          mobile-first approach and extensive community support
                          make it an efficient choice for modern web design.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="service-card style4">
                      <div class="service-img">
                        <img
                          src="../assets/img/services/STACK IMAGES/Web Development/tailwind.webp"
                          alt="Image"
                        />
                      </div>
                      <div class="service-info">
                        ...
                        <h3 class="service-title">
                          <a href="service-details.html">Tailwind</a>
                        </h3>
                        <p>
                          Tailwind facilitates rapid web development with its
                          utility-first approach, enabling a consistent design
                          system and quicker project delivery. Its community
                          support and intuitive class-based styling make it an
                          efficient choice for contemporary web development.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row justify-content-center" id="desktop">
              <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-card style4">
                  <div class="service-img">
                    <img
                      src="../assets/img/services/STACK IMAGES/Web Development/Vue Js.webp"
                      alt="Image"
                    />
                  </div>
                  <div class="service-info">
                    ...
                    <h3 class="service-title">
                      <a href="service-details.html">Vue JS</a>
                    </h3>
                    <p>
                      Vue.js accelerates web development with its
                      component-based architecture, fostering reusability and
                      faster project completion. Its active community and clear
                      documentation make it a versatile and efficient choice for
              ...
              <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-card style4">
                  <div class="service-img">
                    <img
                      src="../assets/img/services/STACK IMAGES/Web Development/Angular Js.webp"
                      alt="Image"
                    />
                  </div>
                  <div class="service-info">
                    ...
                    <h3 class="service-title">
                      <a href="service-details.html">Angular</a>
                    </h3>
                    <p>
                      Angular simplifies web application development with its
                      comprehensive framework, supporting structured and
                      scalable code for faster project delivery. Its extensive
                      community and robust tools make it a powerful choice for
                      building complex, feature-rich web applications.
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-card style4">
                  <div class="service-img">
                    <img
                      src="../assets/img/services/STACK IMAGES/Web Development/React Js.webp"
                      alt="Image"
                    />
                  </div>
                  <div class="service-info">
                    ...
                    <h3 class="service-title">
                      <a href="service-details.html">React JS</a>
                    </h3>
                    <p>
                      React.js streamlines web development with its
                      component-based architecture, enabling efficient code
                      reuse and quicker project delivery. Its vast community and
                      rich ecosystem make it a versatile and powerful choice for
                      building dynamic and interactive web applications.
                    </p>
                  </div>
                </div>
              ...
              <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-card style4">
                  <div class="service-img">
                    <img
                      src="../assets/img/services/STACK IMAGES/Web Development/Laravel.webp"
                      alt="Image"
                    />
                  </div>
                  <div class="service-info">
                    ...
                    <h3 class="service-title">
                      <a href="service-details.html">Laravel</a>
                    </h3>
                    <p>
                      Laravel accelerates web application development with its
                      PHP framework, offering robust features, security, and a
                      streamlined development process. Its active community and
                      elegant syntax make it a versatile and efficient choice
              ...
              <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-card style4">
                  <div class="service-img">
                    <img
                      src="../assets/img/services/STACK IMAGES/Web Development/Node Js.webp"
                      alt="Image"
                    />
                  </div>
                  <div class="service-info">
                    ...
                    <h3 class="service-title">
                      <a href="service-details.html">Node JS</a>
                    </h3>
                    <p>
                      Node.js expedites web development with its JavaScript
                      runtime, facilitating server-side programming and rapid
                      project development. Its extensive package ecosystem and
                      non-blocking I/O make it a powerful choice for building
              ...
              <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-card style4">
                  <div class="service-img">
                    <img
                      src="../assets/img/services/STACK IMAGES/Web Development/Nest Js.webp"
                      alt="Image"
                    />
                  </div>
                  <div class="service-info">
                    ...
                    <h3 class="service-title">
                      <a href="service-details.html">NEST JS</a>
                    </h3>
                    <p>
                      Nest.js streamlines web development with its
                      TypeScript-based framework, offering a structured
                      approach, strong typing, and efficient project delivery.
                      Its active community and modular architecture make it a
                      versatile and efficient choice for building scalable and
                ...
                <div class="sidebar style2">
                  ...
                  <div class="sidebar-widget contact-widget bg-f hero-bg-1">
                    ...
                    <a href="mailto:Info@daamsolutions.com">
                      Info@daamsolutions.com</a
                    >
                    <a href="/contact" class="btn style3">Contact us</a>
                  </div>
                  <div class="sidebar-widget schedule-widget sidebar-widget">
                    <ul class="list-style">
                      <li>
