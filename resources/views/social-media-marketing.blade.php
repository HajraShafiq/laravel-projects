...
@section('content')
  ...
  .br-s {
    background-image: url(../assets/img/services/Social\ Media\ Marketing\ Slider.jpg);
}
  </style>
              ...
              <div class="col-xl-8">
                <div class="service-desc">
                  ...
                  <div class="service-img">
                    <img
                      src="../assets/img/services/social-media-marketing-slider.webp"
                      alt="Image"
                    />
                  </div>
                  <p>
                    Our Social Media Marketing services are tailored to meet
                ...
                <div class="row justify-content-center">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="service-card style4">
                      <div class="service-img">
                        <img
                          src="../assets/img/services/STACK IMAGES/Social Media Marketing/Facebook.webp"
                          alt="Image"
                        />
                      </div>
                      <div class="service-info">
                        ...
                        <h3 class="service-title">
                          <a href="service-details.html">Facebook</a>
                        </h3>
                        <p>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="service-card style4">
                      <div class="service-img">
                        <img
                          src="../assets/img/services/STACK IMAGES/Social Media Marketing/Instagram.webp"
                          alt="Image"
                        />
                      </div>
                      <div class="service-info">
                        ...
                        <h3 class="service-title">
                          <a href="service-details.html">Instagram</a>
                        </h3>
                        <p>
                          Instagram is one of the most important social networks in the world, and is a mobile application that allows users to upload photos and videos
                        </p>
                      </div>
            ...
            <div class="row" id="desktop">
              <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-card style4">
                  <div class="service-img">
                    <img
                      src="../assets/img/services/STACK IMAGES/Social Media Marketing/Snapchat.webp"
                      alt="Image"
                    />
                  </div>
                  <div class="service-info">
                    ...
                    <h3 class="service-title">
                      <a href="service-details.html">Snapchat</a>
                    </h3>
                    <p>
              ...
              <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-card style4">
                  <div class="service-img">
                    <img
                      src="../assets/img/services/STACK IMAGES/Social Media Marketing/Youtube.webp"
                      alt="Image"
                    />
                  </div>
                  <div class="service-info">
                    ...
                    <h3 class="service-title">
                      <a href="service-details.html">Youtube</a>
                    </h3>
                    <p>
                      ouTube is a website designed for sharing video. Millions of users around the world have created accounts on the site that allow them to upload videos.
                    </p>
                  </div></div></div>
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="service-card style4">
                      <div class="service-img">
                        <img
                          src="../assets/img/services/STACK IMAGES/Social Media Marketing/Linkedin.webp"
                          alt="Image"
                        />
                      </div>
                  <div class="service-info">
                    ...
                    <h3 class="service-title">
                      <a href="service-details.html">Linkedin</a>
                    </h3>
                    <p>
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="service-card style4">
                      <div class="service-img">
                        <img
                          src="../assets/img/services/STACK IMAGES/Social Media Marketing/Twitter.webp"
                          alt="Image"
                        />
                      </div>
                  <div class="service-info">
                    ...
                    <h3 class="service-title">
                      <a href="service-details.html">Twitter</a>
                    </h3>
                    <p>
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="service-card style4">
                      <div class="service-img">
                        <img
                          src="../assets/img/services/STACK IMAGES/Social Media Marketing/Tiktok.webp"
                          alt="Image"
                        />
                      </div>
                  <div class="service-info">
                    ...
                    <h3 class="service-title">
                      <a href="service-details.html">TikTok</a>
                    </h3>
                    <p>
